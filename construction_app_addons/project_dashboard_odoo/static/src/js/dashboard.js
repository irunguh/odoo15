odoo.define('pj_dashboard.Dashboard', function(require) {
    ...
    var PjDashboard = AbstractAction.extend({
        ...
        events: {
            ...
            'click .tot_pending_task': 'tot_pending_task',
        ...
        fetch_data: function() {
            ...
            var def1 = this._rpc({
                ...
                self.total_projects = result['total_projects'],
                    ...
                    self.all_pending_tasks = result['all_pending_tasks']
                    self.all_pending_done = result['all_pending_done']
           ...
           var def5 = self._rpc({
                    model: "project.project",
                    method: "get_project_task_completion_data",
                })
                .then(function(res) {
                    self.project_task_data_completion = res['project'];
